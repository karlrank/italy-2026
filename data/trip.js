...
export const packingCategories = [
  {
    ...
    icon: "ticket",
    items: [
      "Passid / ID-kaardid (kõik)",
      "Lennupiletid",
      "Rendiauto broneering + juhiload",
      "Majutuse broneeringud",
      "Reisi- ja ravikindlustus (EHIC kaart)",
      "Pangakaardid + veidi sularaha (€)",
    ],
  },
  {
    id: "kids",
    ...
    icon: "kids",
    items: [
      "Turvatoolid / istmekõrgendused autosse",
      "Mähkmed + niisked salvrätid",
      "Käru või kandekott",
      "Beebitoit ja snäkid",
      "Lemmikmänguasi / unekaaslane",
      "Päikesemütsid ja UV-riided",
      "Ujupüksid / käeujukid",
    ],
  },
  {
    ...
    icon: "sun",
    items: [
      "Suveriided + vahetusriided",
      "Ujumisriided ja rätikud",
      "Üks soojem kiht õhtuks",
      "Mugavad jalanõud + sandaalid",
      "Õhuke vihmajope / vihmakeep",
    ],
  },
  {
    id: "health",
    ...
    icon: "warning",
    items: [
      "Päikesekreem (kõrge SPF)",
      "Putukatõrje",
      "Esmaabi: plaastrid, palavikualandaja",
      "Isiklikud ravimid",
      "Hambaharjad ja hügieenitarbed",
    ],
  },
  {
    id: "tech",
    ...
    items: [
      "Telefonid + laadijad",
      "Pistikuadapter (Itaalia tüüp L/F)",
      "Powerbank",
      "Kaamera",
      "Kõrvaklapid lastele",
    ],
  },
  {
    ...
    icon: "car",
    items: [
      "Navigatsioon / offline-kaardid",
      "Snäkid ja vesi autosse",
      "Prügikotid + salvrätid",
      "Päikesekaitse autoaknale",
    ],
  },
];
