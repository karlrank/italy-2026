...
export const SECTIONS = [
  ...
  },
  {
    key: "flights",
    title: "Lennud",
    hint: "lennunumbrid ja kuupäevad",
    kind: "list",
    titleKey: "direction",
    addLabel: "+ Lisa lend",
    fields: [
      { key: "direction", label: "Suund (nt Väljalend)" },
      { key: "flightNumber", label: "Lennunumber (nt FR1234)" },
  ...
  },
  {
    ...
    addLabel: "+ Lisa auto",
    fields: [
      { key: "family", label: "Pere" },
      { key: "provider", label: "Rendifirma" },
      { key: "accent", label: "Värv", type: "select", options: opt.accent },
      {
        ...
        options: [
          ...
          { value: "likely", label: "Tõenäoline" },
        ],
      },
      { key: "vehicle", label: "Auto", full: true },
      { key: "transmission", label: "Käigukast" },
      { key: "seats", label: "Kohti", type: "number" },
      { key: "luggage", label: "Pagas", type: "number" },
      { key: "pickup", label: "Võtmine" },
      { key: "dropoff", label: "Tagastus" },
      { key: "driver", label: "Juht" },
      { key: "reservation", label: "Broneeringu nr" },
      { key: "price", label: "Hind" },
      { key: "deposit", label: "Tagatis" },
      { key: "url", label: "Link", full: true },
      { key: "note", label: "Märkus", type: "textarea" },
    ],
    newItem: () => ({
